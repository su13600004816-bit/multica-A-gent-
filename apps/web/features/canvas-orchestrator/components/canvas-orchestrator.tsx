...
function CanvasOrchestratorInner() {
  ...
  // online and pass the CLI version gate. Clean releases must be >=
  // MIN_QUICK_CREATE_CLI_VERSION; source/dev builds are accepted to match the
  // server. We pre-flight against this BEFORE
